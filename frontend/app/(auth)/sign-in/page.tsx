...
export default function SignInPage() {
  ...
  return (
    <motion.div
      ...
      className="w-full max-w-[420px] p-[2px] rounded-[12px] relative overflow-hidden"
    >
      {/* ── Animated Border ── */}
      ...
      <div className="relative z-10 p-8 md:p-10 rounded-[11px] backdrop-blur-xl flex flex-col gap-8"
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          ...
          <div className="flex items-center justify-between mt-1 mb-2">
            ...
            <a href="#" className="text-[12px] text-white/40 hover:text-white/80 transition-colors">
              Forgot password?
            </a>
          </div>
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="group relative w-full px-5 py-[13px] text-[13px] font-medium tracking-[0.05em] 
        ...
        <div className="flex items-center gap-3">
          ...
          <span className="text-[10px] uppercase tracking-[0.1em] text-white/30">Or continue with</span>
          <div className="h-px flex-1 bg-white/5" />
        </div>
