...
const StatCard = ({ label, targetValue, suffix = "" }: { label: string, targetValue: number, suffix?: string }) => {
  ...
  return (
    <div ref={ref} className="h-full flex flex-col justify-center relative z-10 w-full group">
      ...
      <span className="text-white/50 text-sm font-medium tracking-wide uppercase mb-2">{label}</span>
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 max-w-5xl mx-auto w-full z-10 relative px-4">
      ...
      <BentoCard className="md:col-span-2 h-[280px]" delayOrder={1}>
        <div className="mb-4">
            <h3 className="font-semibold tracking-wide">Revenue Predictor</h3>
            <p className="text-white/50 text-sm">Real-time NL-to-SQL evaluation</p>
        </div>
      ...
      <BentoCard className="md:col-span-2 py-8 flex flex-col justify-center" delayOrder={4}>
        <div className="text-center mb-8">
            <h3 className="font-medium">Information Architecture</h3>
        </div>
        <div className="flex flex-col md:flex-row items-center justify-between w-full relative px-4 md:px-12">
            ...
            {[
                ...
                <div key={i} className="relative z-10 flex flex-col items-center gap-3 my-4 md:my-0 bg-[#050505] p-2 rounded-xl border border-white/5">
      ...
      {/* 6. CTA Card */}
      <BentoCard className="md:col-span-2 h-[200px] flex items-center justify-center bg-gradient-to-br from-black to-white/[0.02]" delayOrder={5}>
        <div className="flex flex-col items-center hover:cursor-none">
            <h2 className="text-2xl font-semibold mb-6">Ready to see your data differently?</h2>
            <MagneticButton />
        </div>
      </BentoCard>
